...
%.obj: ../%.asm $(GEN_OPTS) | $(GEN_FILES)
	...
	"C:/ti_v8/ccsv8/tools/compiler/ti-cgt-c2000_18.1.4.LTS/bin/cl2000" -v28 -ml -mt --include_path="C:/Users/Joseph/Desktop/Romalo_project/screen_w_BIOS" --include_path="C:/ti_v8/bios_6_76_03_01/packages/ti/posix/ccs" --include_path="C:/ti_v8/ccsv8/tools/compiler/ti-cgt-c2000_18.1.4.LTS/include" -g --diag_warning=225 --diag_wrap=off --display_error_number --preproc_with_compile --preproc_dependency="$(basename $(<F)).d_raw" $(GEN_OPTS__FLAG) "$<"
